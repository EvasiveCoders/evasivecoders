...
?>
<div class="featvid">
  <?php if($node->field_vid_or_doc['und'][0]['value'] == 'video') { ?>
  <div class="vidframe">
  ...
  <div class="vidsocial">
   ...
   <?php } else { ?>
  <div class="techdl"><h5><a href="<?php print file_create_url($node->field_resource['und'][0]['uri']); ?>">&bull; click to download PDF &bull;</a></h5></div>
  ...
  <?php } ?>
  <div class="viddesc">
    <?php print $node->field_technical_description['und'][0]['value']; ?>
  </div>
</div>
<div class="clear"></div>
