...
<div id="search">
    <input type="text" maxlength="128" name="search_theme_form" id="edit-search-theme-form-header" size="12" title="<?php print $search_phrase; ?>" value="<?php print $search_label; ?>" onblur="<?php print $on_blur; ?>" onfocus="<?php print $on_focus; ?>" class="form-text" />
    <div id="submitsearch-wrapper"><input type="submit" name="op" value="search" id="sumbitsearch" class="searchButtonPng" /></div>
