...
<!-- This site has been developed by the creative team at Contemporary Communications Inc. http://www.contemporary-communications.com -->
...
<!--//--><![CDATA[//><!--
jQuery(function() {
 jQuery(".menu li a").prepend("<span class='spanleft'>&bull;</span>").append("<span class='spanright'>&bull;</span>");	
                          ...
                          <div id="content-region-inner" class="content-region-inner inner">
                            ...
                            <div id="content-inner" class="content-inner block">
                              <div id="content-inner-inner" class="content-inner-inner inner">
                                <?php if ($title): ?>
                                <h1 class="title"><?php print $title; ?> <img src="<?php print check_url($front_page); ?>sites/all/themes/acquia_prosper/design_packs/gray/images/h1titlebg.jpg" alt="<?php print $title; ?>" /></h1>
                                <?php endif; ?>
