...
<script type="text/javascript" src="/sites/all/libraries/flowplayer3/example/flowplayer-3.2.2.min.js"></script>
...
if(!isiPhone()){
 jQuery("a.vidtrigger").click(function() {
  var video = jQuery(this).parent().next(".thevid");
  video.show();
  jQuery(this).colorbox({innerWidth: '640px', innerHeight: '360px', inline: true, href: video, onCleanup: function() {
	video.hide();
	}
  });
 });
                              ...
                              <div id="content-inner-inner" class="content-inner-inner inner">
								...
								<div id="closingrow">
								  ...
								  <div id="socialstuff">
									...
									<a href="http://twitter.com/msrmx" rel="external"><img src="<?php print check_url($front_page); ?>sites/all/themes/acquia_prosper/design_packs/gray/images/twiticon.jpg" alt="Follow MSR on Twitter" height="19" /></a>&nbsp;&nbsp;									<a href="http://www.youtube.com/user/msrseventyone" rel="external"><img src="<?php print check_url($front_page); ?>sites/all/themes/acquia_prosper/design_packs/gray/images/msrtube.jpg" height="19" alt="Follow MSR on Youtube" /></a>&nbsp;&nbsp;
