...
<?php if($fields['field_desktop_thumb_fid']->content != "") { ?>
	<div class="itemwrapper">
		<div class="desktopitem" style="background-image: url(<?php print $fields['field_desktop_thumb_fid']->content; ?>)"><span style="background: #fff; padding: 2px;"><?php print $fields['title']->content; ?></span></div>
