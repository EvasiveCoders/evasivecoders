...
<h1 class="title" style="text-transform: uppercase;"><?php print $node->title; ?> <img src="<?php print $themeurl ?>/design_packs/gray/images/h1titlebg.jpg" alt="<?php print $title; ?>" /></h1>
...
<div class="introprods" id="row3">
	...
	<?php if($node->field_intro_title8[0]['value'] != "") { ?><div class="nobottommargin" style="background-image: url(<?php print $baseurl . $node->field_intro_image8[0]['filepath']; ?>)"><a href="<?php if($node->field_intro_title8[0]['value'] != 'hard parts') { print $baseurl . $node->field_intro_path8[0]['value']; } else {print $node->field_intro_path8[0]['value'];} ?>"><span><?php print $node->field_intro_title8[0]['value']; ?></span></a></div> <?php } ?>
