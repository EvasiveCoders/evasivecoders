...
<link rel="stylesheet" type="text/css"href="<?php print check_url($front_page); ?>sites/all/themes/acquia_prosper/css/selectbox.css"/>
  <?php print $scripts; ?>
...
<script type="text/javascript" src="<?php print check_url($front_page); ?>sites/all/themes/acquia_prosper/js/jquery.selectbox-0.5.js"></script>
<script src="<?php print check_url($front_page); ?>sites/all/themes/acquia_prosper/js/jquery.usermode.js" type="text/javascript"></script>
<script src="<?php print check_url($front_page); ?>sites/all/themes/acquia_prosper/js/jquery.bind.js" type="text/javascript"></script>
<script src="<?php print check_url($front_page); ?>sites/all/themes/acquia_prosper/js/ui.checkbox.js" type="text/javascript"></script>
...
jQuery(function() {
 ...
 jQuery("#prodslider").scrollable({size: 1, speed: 500}).autoscroll({interval: 3500}).circular().navigator({navi: "#controls", naviItem: 'a', activeClass: 'current'});
 jQuery("a[rel='external']").click(function(){ this.target = "_blank"; }); 

jQuery("#webform-component-date_of_birth select, #webform-component-gender select").selectbox();
jQuery(".webform-client-form input[type=checkbox]").checkBox({replaceInput: true});
jQuery(".webform-client-form input[type=radio]").checkBox({replaceInput: true});
