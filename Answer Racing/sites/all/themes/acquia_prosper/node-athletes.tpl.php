...
<h1 class="title" style="text-transform: uppercase;"><?php print $node->field_am_nickname[0]['value']; ?> RECOMMENDS  <img src="<?php print $themeurl ?>/css/images/titledown.png" alt="<?php print $title; ?>" /></h1>
