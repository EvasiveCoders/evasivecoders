...
<div id="sizetable">
	<table>
		...
		<?php if($node->field_male_sku1[0]['value'] != "") { ?><tr class="hasborder">
			<td class="tdtitle"><?php print $node->field_helmets_colorway[0]['value']; ?></td>
		...
		<?php if($node->field_female_size1[0]['value'] != "") { ?><tr class="hasborder">
			<td class="tdtitle">SIZE (FEMALE)</td>
		...
		<?php if($node->field_youth_size1[0]['value'] != "") { ?><tr class="hasborder">
			<td class="tdtitle">SIZE (YOUTH)</td>
		...
		<?php if($node->field_youth_sku8[0]['value'] != "") { ?><tr class="hasborder">
			<td><?php print $node->field_helmets_colorway[0]['value']; ?></td> 
...
<h1 class="title">OTHER PRODUCTS <img src="<?php print $themeurl ?>/css/images/titledown.png" alt="<?php print $title; ?>" /></h1>
