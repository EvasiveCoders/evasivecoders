...
?><!DOCTYPE html>
<html>
<!-- This site has been developed by William Hall at Contemporary Communications Inc. http://www.contemporary-communications.com -->
...
jQuery(function() {
 ...
 jQuery("#prodscroll").scrollable({size: 1, speed: 500, clickable: false, items: '.proditems', prev: '#prodprev', next: '#prodnext'}).circular();
 jQuery('.tweetwrap').jScrollPane({showArrows: true, scrollbarWidth: '18'});
