...
<h1 class="title"><?php print $node->title; ?> <img src="<?php print $themeurl ?>/css/images/titledown.png" alt="<?php print $title; ?>" /></h1>
...
<div class="locinfo">
	...
	<div class="locitem"><br /><a href="<?php print $node->field_dealer_website[0]['view']; ?>" rel="nofollow" title="<?php print $node->locations[0]['name']; ?>'s Website">Visit Website</a></div>
...
<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=ABQIAAAAQv0PQgBZa1amW6jsBqm1UBTpN_-NdNAwACZisViE_7DPukkNqhTS7bmi1HpNku8frkASbdfPhc9l7A&amp;sensor=false" type="text/javascript"></script>
